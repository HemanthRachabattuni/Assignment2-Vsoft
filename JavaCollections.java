...
public class JavaCollections {
    public static void main(String[] args) {
        Employee em1 = new Employee("Hemanth", "Rachabattuni", 23, 38000);
        ...
        Employee em5 = new Employee("sravani", "madiraju", 35, 38500);
        ...
        JavaCollections m = new JavaCollections();
    ...
    public void maxSalary(ArrayList<Employee>emp,int sal)
    {
        ...
        for (Employee g:emp){
            ...
            System.out.println("the employee Details of max salary is "+g.firstname+" "+g.lastname+" "+g.age+" "+g.salary);
