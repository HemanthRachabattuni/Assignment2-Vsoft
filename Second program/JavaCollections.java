...
public class JavaCollections {
    ...
    public void salGrt(ArrayList<Employee>emp)
    {
        for(Employee h:emp)
        {
            if((h.salary)>37000)
            {
                System.out.println("employees with salary greater than "+h.firstname+" "+h.lastname+" "+h.age+" "+h.salary);
            }
...
//salLess
    public void salLess(ArrayList<Employee>emp)
    {
            for(Employee i:emp)
            {
                if ((i.salary)<37000)
                {
                    System.out.println("the people with salary lessthan 37k is "+i.firstname+" "+i.lastname+" "+" "+i.salary+" "+i.age);
                }
